...
namespace GYM_Manage.Controllers.Admin
{
    public class ThietBiController : Controller
    {
        ...
        public ThietBiController(GYM_DBcontext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View("~/Views/Admin/ThietBi/Index.cshtml", thietBis);
        }
        ...
        {
            return View("~/Views/Admin/ThietBi/CreateOrEdit.cshtml", new ThietBi());
        }
        ...
        public async Task<IActionResult> Create([Bind("TenThietBi,DanhMuc,NgayMua,NgayBaoTriCuoi,TrangThai")] ThietBi thietBi)
        {
            ...
            return View("~/Views/Admin/ThietBi/CreateOrEdit.cshtml");
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            return View("~/Views/Admin/ThietBi/CreateOrEdit.cshtml", thietBi);
        }
